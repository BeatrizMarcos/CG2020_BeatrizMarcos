...
//#endif
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Triangulo Rosa Claro - Beatriz Marcos", nullptr, nullptr);
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform4f(colorLoc, 1.0f, 0.5f, 1.0f, 1.0f); //enviando cor para variável uniform inputColor
